...
pub use crate::{abstract_collider::AbstractCollider, collider_type::ColliderType};

use utils::heights_and_scale;
...
#[derive(Clone, Debug)]
pub struct AbstractCollidersBuilder<I: GenericImageView<Pixel = Bit>> {
    image: I,
    anchor: Anchor,
    collider_type: ColliderType,
}

impl<I: GenericImageView<Pixel = Bit>> AbstractCollidersBuilder<I> {
